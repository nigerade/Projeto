document.querySelector(".open-popup-btn").addEventListener("click", function (event) {
    ...
    if (nome && email.validity.valid && mensagem) {
        ...
        popup.querySelector(".icon img").src = "../IMGS/sucesso.png"; // Change the source of the success image
        ...
        popup.querySelector(".icon img").src = "../IMGS/x.png"; // Change the source of the error image
